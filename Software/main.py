...
def gui_window_layout_connection():
    imgui.push_font(TITLE_FONT)
    imgui.text("Switch between layouts")
    imgui.pop_font()
...
def create_dockable_windows(app_state: AppState) -> List[hello_imgui.DockableWindow]:
    ...
    layout_connection_window = hello_imgui.DockableWindow()
    layout_connection_window.label = "Connection"
    layout_connection_window.dock_space_name = "MainDockSpace"
    layout_connection_window.gui_function = gui_window_layout_connection
...
def main():
    ...
    runner_params.app_window_params.window_title = "AUT EE AGV"

    runner_params.imgui_window_params.menu_app_title = "AGV Client"
